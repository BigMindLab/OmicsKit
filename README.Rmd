...
+ **Common plots**: Generate a range of visually appealing plots to display differential expression analysis results. Here are some examples
    + **Volcano plots**
...
```
    ...
    + **Enrichment plots**
![Pathway Enrichment with GSEA](man/figures/README-Balloon_plot.jpeg)
