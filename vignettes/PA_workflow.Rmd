...
In this vignetter, we use a built-in example `geneset_list`, which contains
...
```
> **Tip:** Use `fill_limits = c(0, 3)` to prevent a handful of extremely
> significant gene sets from washing out the color contrast for the rest. Any
> pathway with FDR ≤ 0.001 will be shown in the maximum color (red).
